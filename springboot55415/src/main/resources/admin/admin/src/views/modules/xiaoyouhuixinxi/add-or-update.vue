<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="校友会编号" prop="xiaoyouhuibianhao">
            <el-input v-model="ruleForm.xiaoyouhuibianhao" 
                placeholder="校友会编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiaoyouhuibianhao" label="校友会编号" prop="xiaoyouhuibianhao">
              <el-input v-model="ruleForm.xiaoyouhuibianhao" 
                placeholder="校友会编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="校友会名称" prop="xiaoyouhuimingcheng">
          <el-input v-model="ruleForm.xiaoyouhuimingcheng" 
              placeholder="校友会名称" clearable  :readonly="ro.xiaoyouhuimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="校友会名称" prop="xiaoyouhuimingcheng">
              <el-input v-model="ruleForm.xiaoyouhuimingcheng" 
                placeholder="校友会名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jubanshijian" label="举办时间" prop="jubanshijian">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="举办意义" prop="jubanyiyi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="举办意义"
                  v-model="ruleForm.jubanyiyi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jubanyiyi" label="举办意义" prop="jubanyiyi">
                    <span>{{ruleForm.jubanyiyi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	xiaoyouhuibianhao : false,
	xiaoyouhuimingcheng : false,
	tupian : false,
	jubanyiyi : false,
	jubanshijian : false,
	zhuangtai : false,
	fabushijian : false,
      ...
      ruleForm: {
        xiaoyouhuibianhao: this.getUUID(),
        xiaoyouhuimingcheng: '',
        tupian: '',
        jubanyiyi: '',
        jubanshijian: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='xiaoyouhuibianhao'){
            this.ruleForm.xiaoyouhuibianhao = obj[o];
	    this.ro.xiaoyouhuibianhao = true;
            continue;
          }
          if(o=='xiaoyouhuimingcheng'){
            this.ruleForm.xiaoyouhuimingcheng = obj[o];
	    this.ro.xiaoyouhuimingcheng = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='jubanyiyi'){
            this.ruleForm.jubanyiyi = obj[o];
	    this.ro.jubanyiyi = true;
            continue;
          }
          if(o=='jubanshijian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.zhuangtaiOptions = "可加入,已截止".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `xiaoyouhuixinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xiaoyouhuixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xiaoyouhuixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
