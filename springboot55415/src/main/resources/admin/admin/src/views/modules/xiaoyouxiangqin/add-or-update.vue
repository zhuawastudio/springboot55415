...
export default {
  ...
  methods: {
	...
	this.ruleForm.duitadeqidai = this.ruleForm.duitadeqidai.replace(reg,'../../../springboot55415/upload');
	this.ruleForm.ziwojieshao = this.ruleForm.ziwojieshao.replace(reg,'../../../springboot55415/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
