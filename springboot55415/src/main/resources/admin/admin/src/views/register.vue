      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.biyenianfen" class="input" type="text" placeholder="毕业年份">
			   </div>
			 </div> -->
			<el-form-item label="毕业年份" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.biyenianfen" autocomplete="off" placeholder="毕业年份"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20210512/77e03eded6b7401e9dba4ceab12aa40b.jpg);
