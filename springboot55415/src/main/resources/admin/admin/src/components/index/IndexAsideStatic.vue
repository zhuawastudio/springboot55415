      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "rgba(253, 253, 229, 1)"
          })
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = "rgba(234,207,164, 1)"
    ...
    setMenulistIconColor() {
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-submenu__title .el-submenu__icon-arrow').forEach(el=>{
          el.style.color = "rgba(74, 50, 22, 1)"
        })
      })
    },
    menulistStyleChange() {
      ...
      if(1 == str) {
        this.$nextTick(()=>{
          document.querySelectorAll('.el-container .el-container').forEach(el=>{
            ...
            el.style.paddingTop = "58px" // header 高度
          })
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    background-color: rgba(255, 69, 0, 0) !important;
                    box-shadow: 0 0 6px rgba(30, 144, 255, 0);
                    text-align: center;
                }
